...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function () {
    Route::get('/dashboard', function () {
        ...
        Route::prefix('monitoring')->group(function () {
            Route::get('/face-recognition', [\App\Http\Controllers\FaceRecognitionMonitorController::class , 'index'])->name('monitoring.face-recognition');
            Route::get('/api/face-recognition/health', [\App\Http\Controllers\FaceRecognitionMonitorController::class , 'health']);
            Route::get('/api/face-recognition/metrics', [\App\Http\Controllers\FaceRecognitionMonitorController::class , 'metrics']);
        }
        );    });
