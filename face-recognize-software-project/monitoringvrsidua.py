...
if not os.path.exists(path):
    print(f"Error: Path '{path}' does not exist. Please check the folder path.")
    exit()
...
# Video analysis
# video_path = 'C:\Users\Lenovo\Videos\CCTVUII\Camera Lift\1.mp4'
video_path = 'C:\\Users\\Lenovo\\Videos\\CCTVUII\\Camera Lift\\1.mp4'
if not os.path.isfile(video_path):
    print(f"Error: Video file '{video_path}' not found. Check the path.")
    exit()
