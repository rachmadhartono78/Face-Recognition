<x-app-layout>
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tambah Jam Kerja Khusus</h3>
                <p class="text-subtitle text-muted">Tambahkan jadwal jam kerja khusus.</p>
            </div>
    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="card shadow-sm">
            <div class="card-body">
                <h4 class="text-lg font-bold mb-4">Form Tambah Jam Kerja Khusus</h4>
                ...
                <form action="{{ route('settings.special-working-hours.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
