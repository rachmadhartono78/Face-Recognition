<x-maz-sidebar :href="route('dashboard')" :logo="asset('images/logo/logo.png')">
    ...
    <x-maz-sidebar-item name="Dashboard Grafic" :link="route('dashboard-grafic')" icon="bi bi-speedometer2"></x-maz-sidebar-item>
    ...
    <x-maz-sidebar-sub-item name="Manual Generate Laporan Kedisiplinan" :link="route('settings.descipline-reports')" icon="fas fa-file-alt"></x-maz-sidebar-sub-item>
